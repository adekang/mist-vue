...
import MPopconfirm from '../index.ts'
...
describe('popconfirm/index.ts', () => {
  ...
  it('should be exported with withInstall()', () => {
    expect(MPopconfirm.install).toBeDefined()
  })
  ...
  it('should enhance Popconfirm component', () => {
    ...
    expect(enhancedPopconfirm).toBe(MPopconfirm)
...
describe('popconfirm.vue', () => {
  ...
  it('popconfirm emits', async () => {
    ...
    // 弹出层是否出现
    expect(wrapper.find('.m-popconfirm').exists()).toBeTruthy()
    const confirmButton = wrapper.find('.m-popconfirm__confirm')
    expect(confirmButton.exists()).toBeTruthy()

    confirmButton.trigger('click')
    await vi.runAllTimers()
    expect(wrapper.find('.m-popconfirm').exists()).toBeFalsy()
    expect(onConfirm).toBeCalled()

    triggerArea.trigger('click')
    await vi.runAllTimers()
    expect(wrapper.find('.m-popconfirm').exists()).toBeTruthy()
    const cancelButton = wrapper.find('.m-popconfirm__cancel')
