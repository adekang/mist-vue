...
function getSideEffects(partialName, options) {
  ...
  "mist-vue/es/src/".concat(partialName, "/style/index.css")];
}

// import 'mist-vue/es/src/button/style/index.css'
function resolveComponent(name, options) {
  if (options.exclude && name.match(options.exclude)) return;
  if (!name.match(/^M[A-Z]/)) return;
  var partialName = toKebabCase(name.slice(1));
  return {
...
function MistResolver() {
  ...
  function _resolveOptions() {
    _resolveOptions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", optionsResolved);
          case 2:
      ...
      var _resolve = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              options2 = _context.sent;
              return _context.abrupt("return", resolveComponent(name, options2));
            case 6:
            case "end":
