...
<template>
  <MTree :data="data" checkable>
    ...
    <template #content="treeNode">
      <svg
        v-if="treeNode.isLeaf" id="octicon_file_16" style="margin-right: 8px;" viewBox="0 0 16 16" width="16"
        height="16" fill="#57606a" :style="{ display: 'inline-block' }"
      >
        <path
          fill-rule="evenodd"
      ...
      <svg
        v-else id="octicon_file-directory-fill_16" viewBox="0 0 16 16" width="16" height="16" fill="#54aeff"
      ...
      {{ treeNode.label }}
      <svg
        v-if="treeNode.isLeaf" title="modified" viewBox="0 0 16 16" width="16" height="16" fill="#9a6700"
